...
import (
	...
	pr5559 "github.com/prometheus/alertmanager/5559updatedinhibit"
...
// TestReplay feeds a recorded alert stream to the PR 5559 inhibitor, and
// alongside it replays the flush log a dispatcher produced from the same
// recording.
//
