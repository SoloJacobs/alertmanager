...
func TestLogSilence(t *testing.T) {
	...
	require.Contains(t, logOutput, fmt.Sprintf("StartsAt=%s", now.Format("RFC3339")))
	require.Contains(t, logOutput, fmt.Sprintf("EndsAt=%s", now.Add(time.Hour).Format("RFC3339")))
