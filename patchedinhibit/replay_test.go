...
import (
	...
	patched "github.com/prometheus/alertmanager/patchedinhibit"
...
// TestReplay feeds a recorded alert stream to the patched inhibitor, and
// alongside it
...
func TestReplay(t *testing.T) {
	...
	synctest.Test(t, func(t *testing.T) {
		...
		inhibitor := patched.NewInhibitor(
			alerts,
			conf.InhibitRules,
